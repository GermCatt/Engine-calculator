...
class Attitude:
    def __init__(self, delta_t) -> None:
        self.clean_accs = None
        self.gs = None
        self.dt = delta_t

    def calculate(self, accs, omegas):
        """
        ...
        omega0 = omegas[0]
        a0 = accs[0]
        g_quaternion = pyquaternion.Quaternion(0, -a0[0], -a0[1], -a0[2])  # g in form of quaternion
        self.gs = []
        self.clean_accs = []
        ...
        for i in range(len(omegas)):
            ...
            g_rotated_vector = g_rotated.imaginary
